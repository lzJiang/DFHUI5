sap.ui.define([
	"zui50018/libs/jspdfumdmin",
	"zui50018/font/font",
], function (jspdfmin153,font) {
	"use strict";
	// jQuery.sap.require("zui50018/libs/jspdfmin153");
	// jQuery.sap.require("zui50018/libs/jspdfpluginautotablemin");
	return {

		//Find jsPDF source on https://cdnjs.com/libraries/jspdf

		getJsPdfDoc: function () {
			jQuery.sap.require("zui50018/libs/jspdfpluginautotable");
