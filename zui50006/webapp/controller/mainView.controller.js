sap.ui.define([
    ...
    "sap/m/MessageToast",
    "sap/m/MessageBox",
    "zui50006/model/odataUtil",
    "sap/ui/model/Sorter",
    "zui50006/model/formatter",
    ...
    return BaseController.extend("zui50006.controller.mainView", {
        currentType: null,
        confirm: null,
        formatter: formatter,
        onInit() {
        ...
        _onItemSearch: async function (item, path) {
            ...
            var RequestParameter = {
                ...
                zj: item.zj,
                storagelocation: this.isEmpty(item.storagelocation) ? "" : item.storagelocation
            };
        ...
        onValueHelpRequest: async function (oEvent) {
            ...
            if (!this._pValueHelpDialog) {
            	this._pValueHelpDialog = Fragment.load({
            		id: oView.getId(),
            		name: "zui50006.view.productValueHelpDialog",
            		controller: this
            ...
            // this._pValueHelpDialog ??= await this.loadFragment({
            //     name: "zui50006.view.productValueHelpDialog"
            // });
