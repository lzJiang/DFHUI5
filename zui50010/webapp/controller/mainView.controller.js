sap.ui.define([
    ...
    "sap/m/MessageToast",
    "sap/m/MessageBox",
    "zui50010/model/odataUtil",
    "sap/ui/model/Sorter",
    "zui50010/model/formatter",
    ...
    return BaseController.extend("zui50010.controller.mainView", {
        currentType: null,
        confirm: null,
        formatter:formatter,
        onInit() {
        ...
        createPdfDoc:function(data){
			...
			var wind = window.open("/sap/bc/ui5_ui5/sap/zui50010/print/print.html","PrintWindow","");
